...
set COMPILE_CPP_SRCS=CommandList.cpp SimpleCommand.cpp SimpleLength.cpp SimplePathWriter.cpp dependencies\parseCmdline\source\lex.pcl.c dependencies\parseCmdline\source\pcl.tab.c dependencies\split_string\split_string.cpp lex.yy.c simpleGlobals.cpp simpleMain.cpp y.tab.c
